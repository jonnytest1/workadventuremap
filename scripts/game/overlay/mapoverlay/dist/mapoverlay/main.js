...
/* harmony import */ var _inentory_items__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./inentory-items */ "UDs4");
...
class InventarComponent {
    constructor(cdr, apiService) {
        ...
        this.menuItem = null;
        this.activeIndex = 0;
        this.inventoryMap = _inentory_items__WEBPACK_IMPORTED_MODULE_3__["inventoryTypeMap"];
    ...
    getImageSource(item) {
        if (item.itemType == 0 /* Random */) {
            return item.src = `assets/img/${_inentory_items__WEBPACK_IMPORTED_MODULE_3__["inventoryTypeMap"][item.itemType].image}.svg`;
        }
    ...
    gotoPrivateMap() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                ...
                this.apiService.WAApi("goToRoom", `/_/global/${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].mapServerOrigin}/mapserver/rest/mapserver/usermap/${referenceUuid}.json`);
            }
            catch (e) {
                console.error(e);
            }
...
/***/ "UDs4":
/*!********************************************!*\
  !*** ./src/app/inventar/inentory-items.ts ***!
  \********************************************/
